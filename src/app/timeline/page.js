export default function Timeline() {
  const milestones = [
    { name: "Start Internship", date: "April 1, 2025", status: "Completed" },
    { name: "Midpoint Review", date: "May 1, 2025", status: "Completed" },
    { name: "Final Presentation", date: "June 22, 2025", status: "Pending" },
  ];
